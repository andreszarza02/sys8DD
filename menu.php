...
$persona = "select count(*) as cantidad_persona from personas;";
$resultado = pg_query($conexion, $persona);
$cantidad_persona = pg_fetch_assoc($resultado);

$funcionario = "select count(*) as cantidad_funcionario from funcionario;";
$resultado2 = pg_query($conexion, $funcionario);
$cantidad_funcionario = pg_fetch_assoc($resultado2);

$usuario = "select count(*) as cantidad_usuario from usuario;";
$resultado3 = pg_query($conexion, $usuario);
$cantidad_usuario = pg_fetch_assoc($resultado3);

$cliente = "select count(*) as cantidad_cliente from cliente;";
$resultado4 = pg_query($conexion, $cliente);
$cantidad_cliente = pg_fetch_assoc($resultado4);
?>
<!DOCTYPE html>
<html>
...
<body class="theme">
   ...
   <section class="content">
      <div class="container-fluid">
         <?php if ($_SESSION['usuario']['modu_descripcion'] == "SISTEMA") { ?>

            <div class="block-header">
               <h2>INFORMACION DE SISTEMA</h2>
            </div>
                  ...
                  <div class="info-box bg-teal hover-expand-effect">
                     ...
                     <div class="content">
                        ...
                        <div class="number count-to" data-from="0"
                           data-to="<?php echo $cantidad_persona['cantidad_persona'] ?>" data-speed="15"
               ...
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <div class="info-box bg-teal hover-expand-effect">
                     ...
                     <div class="content">
                        ...
                        <div class="number count-to" data-from="0"
                           data-to="<?php echo $cantidad_funcionario['cantidad_funcionario'] ?>" data-speed="1000"
               ...
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <div class="info-box bg-teal hover-expand-effect">
                     ...
                     <div class="content">
                        ...
                        <div class="number count-to" data-from="0"
                           data-to="<?php echo $cantidad_usuario['cantidad_usuario'] ?>" data-speed="1000"
                           data-fresh-interval="20"></div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                  <div class="info-box bg-teal hover-expand-effect">
                     ...
                     <div class="content">
                        ...
                        <div class="number count-to" data-from="0"
                           data-to="<?php echo $cantidad_cliente['cantidad_cliente'] ?>" data-speed="1000"
                           data-fresh-interval="20"></div>
                     </div>
                  </div>
               </div>
