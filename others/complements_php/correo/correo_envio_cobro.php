...
try {
   ...
   <head>
      ...
      <style>
         ...
         .header {
               background-color:rgb(12, 143, 119);
               color: #ffffff;
               text-align: center;
               padding: 20px;
         }
      ...
      <div class="container">
         ...
         <div class="content">
               ...
               <ul>
                  ...
                  <li><strong>Fecha:</strong> ' . $detalle['fecha'] . '</li>
               </ul>
               ...
               <p>Atentamente,<br><strong>' . $logo['emp_razonsocial'] . ' - ' . $logo['suc_descripcion'] . '</strong></p>
         </div>
         <div class="footer">
               &copy; ' . date("Y") . ' ' . $logo['emp_razonsocial'] . '. Todos los derechos reservados.
         </div>
      </div>
   </body>
   </html>';
