...
$presupuesto = pg_escape_string($conexion, $_POST['pro_razonsocial']);
...
$sql = "select 
      ...
      from pedido_presupuesto pp
         ...
         where (p.pro_razonsocial ilike '%$presupuesto%' or p.pro_ruc ilike '%$presupuesto%') and ppc.prepro_estado='ACTIVO'
