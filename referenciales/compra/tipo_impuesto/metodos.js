...
const getCodigo = () => {
  $.ajax({
    ...
    $("#tipim_codigo").val(respuesta.tipim_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.tipim_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipim_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipim_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  $("#tipim_codigo").val(0);
  $("#tipim_estado").val("ACTIVO");
  habilitarBotones(false);
  $("#tipim_descripcion").val("");
  $("#tImpuestos").attr("style", "display: none;");
...
const controlVacio = () => {
  ...
  if ($("#tipim_codigo").val() == 0) {
    condicion = true;
  } else if ($("#tipim_descripcion").val() == "") {
    condicion = true;
  } else if ($("#tipim_estado").val() == "") {
    condicion = true;
  }
