...
<head>
   ...
   <title>Funcionario Proveedor</title>
   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Funcionario Proveedor -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE FUNCIONARIO PROVEEDOR<small style="color: white; font-weight: bold;">Mantener
                           referencial
                           funcionario proveedor</small>
                     </h2>
                  </div>
                  <div class="body">
                     ...
                     <div class="row clearfix">
                        <div class="col-sm-1">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="funpro_codigo" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line foco">
                                 <input type="text" class="form-control no-disabled solo-numeros" id="funpro_documento"
                                    disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line pro">
                                 ...
                                 <input type="hidden" id="tipro_descripcion" value="0">
                                 ...
                                 <label class="form-label">Proveedor (RUC o Razón Social)</label>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="funpro_estado" disabled>
            ...
            <!-- Grilla Funcionario Proveedor -->
            <div id="funcionarios_proveedor" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           FUNCIONARIOS PROVEEDOR REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              funcionarios proveedor
                              registrados</small>
                        </h2>
                     </div>
                     <div class="body">
