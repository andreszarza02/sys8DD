...
if (isset($_POST['operacion'])) {
   ...
   $descripcion = $_POST['tipro_descripcion'];
   $tipro_descripcion = str_replace("'", "''", $descripcion);

   $estado = $_POST['tipro_estado'];
   $tipro_estado = str_replace("'", "''", $estado);
   ...
   if (strpos($error, "1") !== false) {
      $response = array(
         "mensaje" => "YA EXISTE EL TIPO DE PROVEEDOR",
         "tipo" => "error"
      );
   } else {
      $response = array(
