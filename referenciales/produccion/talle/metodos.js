...
const getCodigo = () => {
  $.ajax({
    ...
    $("#tall_codigo").val(respuesta.tall_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.tall_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tall_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tall_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
