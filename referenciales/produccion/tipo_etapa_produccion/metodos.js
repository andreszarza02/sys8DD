...
const getCodigo = () => {
  $.ajax({
    ...
    $("#tipet_codigo").val(respuesta.tipet_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.tipet_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipet_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipet_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
