...
const getCodigo = () => {
  $.ajax({
    ...
    $("#unime_codigo").val(respuesta.unime_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.unime_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.unime_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.unime_simbolo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.unime_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const abm = () => {
  $.ajax({
    ...
    data: {
      ...
      unime_simbolo: $("#unime_simbolo").val(),
      unime_estado: $("#unime_estado").val(),
...
const controlVacio = () => {
  ...
  if ($("#unime_codigo").val() == "") {
    ...
    condicion = true;
  } else if ($("#unime_simbolo").val() == "") {
    condicion = true;
  } else if ($("#unime_estado").val() == "") {
    condicion = true;
  }
