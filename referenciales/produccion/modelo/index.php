               ...
               <div class="card">
                  ...
                  <div class="body">
                     ...
                     <div class="row clearfix">
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="mod_codigo" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line se">
                                 <input type="text" class="form-control no-disabled" id="mod_sexo" disabled
                                    onclick="getSexo()">
                                 <label class="form-label">Sexo</label>
                                 <div id="listaSexo" style="display: none;">
                                    <ul class="list-group" id="ulSexo" Style="height: 100px; overflow: auto"></ul>
                                 </div>
                              </div>
                           </div>
                        </div>
