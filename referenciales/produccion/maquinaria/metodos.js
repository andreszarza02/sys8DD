...
const getCodigo = () => {
  $.ajax({
    ...
    $("#maq_codigo").val(respuesta.maq_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.maq_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.maq_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.maq_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  getCodigo();
  $("#maquinarias").attr("style", "display: none");
  $(".est").attr("class", "form-line est focused");
  $("#maq_estado").val("ACTIVO");
  $("#maq_descripcion").val("");
