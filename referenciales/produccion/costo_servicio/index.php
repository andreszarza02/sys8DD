   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Costo Servicio -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        FORMULARIO DE COSTO SERVICIO<small>Mantener referencial costo servicio</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="text" class="form-control" id="costserv_codigo" disabled>
                           ...
                           <div class="form-group form-float">
                              <div class="form-line mo">
                                 ...
                                 <div id="listaModelo" style="display: none;">
                                    <ul class="list-group" id="ulModelo"
                                       Style="height: 80px; width: 325px; overflow: auto"></ul>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line foco">
                                 <input type="text" class="form-control no-disabled" id="costserv_costo" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="costserv_estado" disabled>
            ...
            " style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header">
                        <h2>
                           COSTOS DE SERVICIOS REGISTRADOS <small>Lista de costos de servicios registrados</small>
                        </h2>
                     </div>
                     <div class="body">
