   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Color Prenda -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE COLOR PRENDA<small style="color: white; font-weight: bold;">Mantener referencial
                           color prenda</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="col_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="col_estado" disabled>
            ...
            <!-- Grilla Color Prenda -->
            <div id="colores" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           COLORES DE PRENDAS REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              colores de prendas registradas</small>
                        </h2>
                     </div>
                     <div class="body">
