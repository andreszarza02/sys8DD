         ...
         <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        FORMULARIO DE COLOR PRENDA<small>Mantener referencial color prenda</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="col_estado" disabled>
            ...
            <div id="colores" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header">
                        <h2>
                           COLORES DE PRENDAS REGISTRADOS <small>Lista de colores de prendas registradas</small>
                        </h2>
                     </div>
                     <div class="body">
