   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Equipo Trabajo-->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE EQUIPO TRABAJO<small style="color: white; font-weight: bold;">Mantener referencial
                           equipo trabajo</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line secc">
                                 ...
                                 <input type="text" class="form-control" id="secc_descripcion" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="eqtra_estado" disabled>
            ...
            <!-- Grilla Equipo Trabajo-->
            <div id="equipos" style="display: block">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           EQUIPOS DE TRABAJO REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
