   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE SECCION<small style="color: white; font-weight: bold;">Mantener referencial
                           seccion</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-1">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="text" class="form-control" id="secc_codigo" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="secc_estado" disabled>
            ...
            <!-- Grilla Seccion -->
            <div id="secciones" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           SECCIONES REGISTRADAS <small style="color: white; font-weight: bold;">Lista de secciones
                              registradas</small>
                        </h2>
                     </div>
                     <div class="body">
