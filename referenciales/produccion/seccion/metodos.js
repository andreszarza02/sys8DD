...
const getCodigo = () => {
  $.ajax({
    ...
    $("#secc_codigo").val(respuesta.secc_codigo);
  });
};
...
const agregar = () => {
  ...
  getCodigo();
  $("#secciones").attr("style", "display: none");
  $("#ulSucursal").html("");
...
const getEmpresa = () => {
  $.ajax({
    //Solicitamos los datos a listaEmpresa
    method: "POST",
...
const getSucursal = (CodigoSucursal) => {
  $.ajax({
    //Solicitamos los datos a listaSucursal
    method: "POST",
