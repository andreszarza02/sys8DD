...
const getCodigo = () => {
  $.ajax({
    ...
    $("#pacoca_codigo").val(respuesta.pacoca_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.pacoca_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.pacoca_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.pacoca_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const abm = () => {
  $.ajax({
    ...
    data: {
      ...
      pacoca_estado: $("#pacoca_estado").val(),
...
const controlVacio = () => {
  ...
  if ($("#pacoca_codigo").val() == "") {
    condicion = true;
  } else if ($("#pacoca_descripcion").val() == "") {
    condicion = true;
  } else if ($("#pacoca_estado").val() == "") {
    condicion = true;
  }
