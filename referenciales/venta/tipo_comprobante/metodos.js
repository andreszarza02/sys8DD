...
const getCodigo = () => {
  $.ajax({
    ...
    $("#tipco_codigo").val(respuesta.tipco_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.tipco_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipco_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipco_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  $("#tipco_estado").val("ACTIVO");
  $("#tipco_descripcion").val("");
  habilitarBotones(false);
  $("#tComprobantes").attr("style", "display: none");
};
