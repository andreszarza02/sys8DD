   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Tipo Comprobante -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE TIPO COMPROBANTE<small style="color: white; font-weight: bold;">Mantener
                           referencial tipo comprobante</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="tipco_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="tipco_estado" disabled>
            ...
            <!-- Grilla Tipo Comprobante -->
            <div id="tComprobantes" style="display: block">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           TIPOS DE COMPROBANTES REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              tipos de comprobantes registrados</small>
                        </h2>
                     </div>
                     <div class="body">
