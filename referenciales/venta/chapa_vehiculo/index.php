   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Chapa Vehiculo -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE CHAPA VEHICULO<small style="color: white; font-weight: bold;">Mantener
                           referencial
                           chapa vehiculo</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="chave_codigo" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line mod">
                                 ...
                                 <input type="hidden" id="modve_descripcion" value="0">
                                 <input type="hidden" id="marve_descripcion" value="0">
                                 <input type="text" class="form-control no-disabled letras-numeros" id="descripcion"
                                    disabled onkeyup="getModeloVehiculo()">
                                 <label class="form-label">Modelo o Marca Vehiculo</label>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="chave_estado" disabled>
            ...
            <!-- Grilla Chapa Vehiculo -->
            <div id="chapas_vehiculos" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           MARCAS DE VEHICULOS REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              marcas de vehiculos registrados</small>
                        </h2>
                     </div>
                     <div class="body">
