   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE MODELO VEHICULO<small style="color: white; font-weight: bold;">Mantener
                           referencial
                           modelo vehiculo</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="modve_codigo" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line mar">
                                 ...
                                 <input type="text" class="form-control no-disabled solo-letras" id="marve_descripcion"
                                    disabled onkeyup="getMarcaVehiculo()">
                                 <label class="form-label">Marca Vehiculo</label>
                                 <div id="listaMarca" style="display: none;">
                                    <ul class="list-group" id="ulMarca" Style="height: 100px; overflow: auto"></ul>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="modve_estado" disabled>
            ...
            <!-- Grilla Marca Vehiculo -->
            <div id="modelos_vehiculos" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
