...
const getCodigo = () => {
  $.ajax({
    ...
    $("#tipdo_codigo").val(respuesta.tipdo_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.tipdo_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipdo_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.tipdo_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  $("#tipdo_estado").val("ACTIVO");
  $("#tipdo_descripcion").val("");
  habilitarBotones(false);
  $("#tDocumentos").attr("style", "display: none");
};
