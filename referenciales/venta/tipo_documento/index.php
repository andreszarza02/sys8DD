   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE TIPO DOCUMENTO<small style="color: white; font-weight: bold;">Mantener referencial
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="tipdo_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="tipdo_estado" disabled>
            ...
            <!-- Grilla Tipos Documentos -->
            <div id="tDocumentos" style="display: block">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           TIPOS DE DOCUMENTOS REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              tipos de documentos registrados</small>
                        </h2>
                     </div>
                     <div class="body">
