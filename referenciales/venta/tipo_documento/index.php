         ...
         <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        FORMULARIO DE TIPO DOCUMENTO<small>Mantener referencial tipo documento</small>
                     </h2>
                  </div>
                  <div class="body">
            ...
            <div id="tDocumentos" style="display: block">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header">
                        <h2>
                           TIPOS DE DOCUMENTOS REGISTRADOS <small>Lista de tipos de documentos registrados</small>
                        </h2>
                     </div>
                     <div class="body">
