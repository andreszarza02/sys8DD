...
const getCodigo = () => {
  $.ajax({
    ...
    $("#marta_codigo").val(respuesta.marta_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.marta_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.marta_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.marta_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  $("#marta_estado").val("ACTIVO");
  $("#marta_descripcion").val("");
  habilitarBotones(false);
  $("#mTarjeta").attr("style", "display: none");
};
...
const controlVacio = () => {
  ...
  if ($("#marta_codigo").val() == 0) {
    condicion = true;
  } else if ($("#marta_descripcion").val() == "") {
    condicion = true;
  } else if ($("#marta_estado").val() == "") {
    condicion = true;
  }
