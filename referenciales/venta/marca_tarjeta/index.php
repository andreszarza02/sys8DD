   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Marca Tarjeta-->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE MARCA TARJETA<small style="color: white; font-weight: bold;">Mantener referencial
                           marca tarjeta</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="marta_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="marta_estado" disabled>
            ...
            <!-- Grilla Marca Tarjeta -->
            <div id="mTarjeta" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           MARCAS DE TARJETAS REGISTRADAS <small style="color: white; font-weight: bold;">Lista de
                              marcas de tarjetas registradas</small>
                        </h2>
                     </div>
                     <div class="body">
