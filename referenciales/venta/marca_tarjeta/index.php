         ...
         <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        FORMULARIO DE MARCA TARJETA<small>Mantener referencial marca tarjeta</small>
                     </h2>
                  </div>
                  <div class="body">
            ...
            <div id="mTarjeta" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header">
                        <h2>
                           MARCAS DE TARJETAS REGISTRADAS <small>Lista de marcas de tarjetas registradas</small>
                        </h2>
                     </div>
                     <div class="body">
