   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE TIPO CLIENTE<small style="color: white; font-weight: bold;">Mantener referencial
                           tipo cliente</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="ticli_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line foco">
                                 <input type="text" class="form-control no-disabled solo-letras" id="ticli_descripcion"
                                    disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="ticli_estado" disabled>
            ...
            <!-- Grilla Tipo Cliente -->
            <div id="tipos_clientes" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           TIPOS DE CLIENTES REGISTRADOS <small style="color: white; font-weight: bold;">Lista de tipos
                              de clientes
                              registrados</small>
                        </h2>
                     </div>
