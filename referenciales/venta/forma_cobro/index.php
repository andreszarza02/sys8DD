                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="forco_codigo" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line foco">
                                 <input type="text" class="form-control no-disabled" id="forco_descripcion" disabled>
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="forco_estado" disabled>
