...
const getCodigo = () => {
  $.ajax({
    ...
    $("#forco_codigo").val(respuesta.forco_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.forco_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.forco_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.forco_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
...
const agregar = () => {
  ...
  $("#forco_estado").val("ACTIVO");
  $("#forco_descripcion").val("");
  habilitarBotones(false);
  $("#fCobro").attr("style", "display: none");
};
...
const controlVacio = () => {
  ...
  if ($("#forco_codigo").val() == 0) {
    condicion = true;
  } else if ($("#forco_descripcion").val() == "") {
    condicion = true;
  } else if ($("#forco_estado").val() == "") {
    condicion = true;
  }
