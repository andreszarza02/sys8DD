               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE GUI<small style="color: white; font-weight: bold;">Mantener referencial
                           gui</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="number" class="form-control" id="gui_codigo" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="gui_estado" disabled>
            ...
            <div id="gui" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           GUI REGISTRADOS <small style="color: white; font-weight: bold;">Lista de gui
                              registrados</small>
                        </h2>
                     </div>
                     <div class="body">
