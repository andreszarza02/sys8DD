         ...
         <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        FORMULARIO DE PERFILES PERMISOS<small>Mantener referencial perfiles permisos</small>
                     </h2>
                  </div>
                  <div class="body">
            ...
            <div id="perfilesPermisos" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header">
                        <h2>
                           PERFILES PERMISOS REGISTRADOS <small>Lista de perfiles permisos registrados</small>
                        </h2>
                     </div>
                     <div class="body">
