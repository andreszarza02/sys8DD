   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
               ...
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        FORMULARIO DE PERFILES PERMISOS<small style="color: white; font-weight: bold;">Mantener
                           referencial perfiles permisos</small>
                     </h2>
                  </div>
                  <div class="body">
                        ...
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control no-disabled" id="perfpe_estado" disabled>
            ...
            <!-- Grilla Perfiles Permisos -->
            <div id="perfilesPermisos" style="display: block;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           PERFILES PERMISOS REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                              perfiles permisos registrados</small>
                        </h2>
                     </div>
                     <div class="body">
