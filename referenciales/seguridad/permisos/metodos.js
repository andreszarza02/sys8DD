...
const getCodigo = () => {
  $.ajax({
    ...
    $("#perm_codigo").val(respuesta.perm_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.perm_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.perm_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.perm_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
