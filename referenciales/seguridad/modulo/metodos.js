...
const getCodigo = () => {
  $.ajax({
    ...
    $("#modu_codigo").val(respuesta.modu_codigo);
  });
};
    ...
    .done(function (respuesta) {
      ...
      for (objeto of respuesta) {
        tabla +=
          ...
          ")'>";
        tabla += "<td>";
        tabla += objeto.modu_codigo;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.modu_descripcion;
        tabla += "</td>";
        tabla += "<td>";
        tabla += objeto.modu_estado;
        tabla += "</td>";
        tabla += "</tr>";
      }
