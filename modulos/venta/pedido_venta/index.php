   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line fecha">
                                 <input type="text" class="form-control" id="peven_fecha" disabled>
                           ...
                           <div class="form-group form-float">
                              <div class="form-line cli">
                                 <input type="text" class="form-control no-disabled numeros-algunos-simbolos"
                                    id="per_numerodocumento" disabled onkeyup="getCliente()">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="peven_estado" disabled>
            ...
            <!-- Formulario Pedido Venta Detalle -->
                     ...
                     <div class="body">
                        ...
                        <div class="row clearfix">
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line it">
                                    ...
                                    <input type="text" class="form-control no-disabled2 letras_numeros" id="item"
                           ...
                           <div class="col-sm-2">
                              <div class="form-group form-float">
                                 <div class="form-line it">
                                    <input type="text" class="form-control" id="pevendet_precio" disabled>
            ...
            <!-- Grilla Pedido Venta Cabecera -->
            <div class="col-lg-12 col-md-12 col-sm-12" id="cabecera" style="display: block">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        PEDIDOS DE VENTAS REGISTRADOS <small style="color: white; font-weight: bold;">Lista de Pedidos
                           Registrados</small>
                     </h2>
                  </div>
                  <div class="body">
