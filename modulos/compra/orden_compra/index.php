   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
                  ...
                  <div class="body">
                     ...
                     <div class="row clearfix">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line fecha">
                                 <input type="text" class="form-control" id="orcom_fecha" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line pro">
                                 <input type="hidden" id="pedco_codigo" value="0">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="orcom_estado" disabled>
            ...
            <!-- Formulario Orden Compra Detalle -->
                     ...
                     <div class="body">
                        ...
                        <div class="icon-and-text-button-demo">
                           ...
                           <div class="botonesExtra4" style="display: none;">
                              <button type="button" class="btn bg-orange waves-effect" onclick="controlVacio2()">
                                 <i class="material-icons">save</i>
                                 <span>CONFIRMAR</span>
                              </button>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" id="cabecera">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        ORDENES DE COMPRAS REGISTRADAS <small style="color: white; font-weight: bold;">Lista de Ordenes
                           de Compras Registradas</small>
                     </h2>
                  </div>
                  <div class="body">
                     <div class="table-responsive">
