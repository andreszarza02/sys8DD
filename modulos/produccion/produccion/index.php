         ...
         <div class="row clearfix">
                  ...
                  <div class="body">
                     ...
                     <div class="row clearfix">
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line fecha">
                                 <input type="text" class="form-control" id="prod_fecha" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line or">
                                 ...
                                 <label class="form-label">N° Orden</pelabel>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-1">
                           <div class="form-group form-float">
                              <div class="form-line or">
                                 <input type="text" class="form-control" id="orpro_fechainicio" disabled>
                        ...
                        <div class="col-sm-2">
                           <div class="form-group form-float">
                              <div class="form-line or">
                                 <input type="text" class="form-control" id="orpro_fechaculminacion" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="prod_estado" disabled>
                  ...
                  <div class="card">
                     ...
                     <div class="body">
                        ...
                        <div class="row clearfix">
                           ...
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line foco2 focused">
                                    <input type="date" class="form-control no-disabled2" id="prodet_fechainicio"
                                       disabled>
                                    <label class="form-label">Fecha Inicio</label>
                                 </div>
                              </div>
                           ...
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line foco2 focused">
                                    <input type="date" class="form-control no-disabled2" id="prodet_fechafinal"
                                       disabled>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" id="cabecera" style="display: block;">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        PRODUCCIONES REGISTRADAS <small style="color: white; font-weight: bold;">Lista de Producciones
                           Registradas</small>
                     </h2>
                  </div>
                  <div class="body">
