   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line activar">
                                 <input type="text" class="form-control" id="conca_codigo" disabled>
                                 <label class="form-label">N° C. Calidad</label>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line fecha">
                                 <input type="text" class="form-control" id="conca_fecha" disabled>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line est">
                                 <input type="text" class="form-control" id="conca_estado" disabled>
            ...
            <!-- Formulario Control Calidad Detalle -->
            <div id="detalle" style="display: none;">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="card">
                     <div class="header" style="background: #4DC18B;">
                        <h2 style="color: white; font-weight: bold;">
                           DETALLE CONTROL CALIDAD
                        </h2>
                     </div>
                     <div class="body">
                        ...
                        <!-- Grilla Control Calidad Detalle -->
                           ...
                           <table class="table table-bordered table-striped table-hover">
                              <thead>
                                 <tr>
                                    <th>ITEM</th>
                                    <th>TALLE</th>
                                    <th>PARAMETRO CONTROL CALIDAD</th>
                                    <th>CANTIDAD FALLIDA</th>
                                    <th>UNIDAD MEDIDA</th>
                                 </tr>
                              </thead>
            ...
            <!-- Grilla Control Calidad Detalle 2 -->
            <div class="col-lg-12 col-md-12 col-sm-12" id="detalle2" style="display: none;">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        GRILLA DE CONTROL DE PRODUCTOS <small style="color: white; font-weight: bold;">Lista de
                           Productos Total, Fallido y Correctos</small>
                     </h2>
                  </div>
                  <div class="body">
                     <div class="table-responsive">
            ...
            <!-- Grilla Control Calidad -->
            <div class="col-lg-12 col-md-12 col-sm-12" id="cabecera" style="display: block;">
               <div class="card">
                  <div class="header" style="background: #4DC18B;">
                     <h2 style="color: white; font-weight: bold;">
                        CONTROLES DE CALIDAD REGISTRADOS <small style="color: white; font-weight: bold;">Lista de
                           Controles de Calidad Registrados</small>
                     </h2>
                  </div>
                  <div class="body">
                     <div class="table-responsive">
