   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Informe Movimiento Compra -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        INFORME MODULO COMPRA
                     </h2>
                  </div>
                  <div class="body">
                     <div class="row clearfix">
                        <div class="movimientos" style="display: true;">
                           <div class="col-sm-3">
                        ...
                        <div class="stock" style="display: none;">
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line focused">
                                    <input type="hidden" id="empresacodigo" value="<?php echo $empresaCodigo ?>">
                                    <input type="text" class="form-control" id="empresa" value="<?php echo $empresa ?>"
                                       disabled>
                           ...
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line focused">
                                    <input type="hidden" id="sucursalCodigo" value="<?php echo $sucursalCodigo ?>">
                           ...
                           <div class="col-sm-3">
                              <div class="form-group form-float">
                                 <div class="form-line dep focused">
                                    <input type="hidden" id="dep_codigo" value="0">
                                    <input type="text" class="form-control" id="dep_descripcion"
                                       onclick="getDeposito()">
                                    <label class="form-label">DEPOSITO</label>
                                    <div id="listaDeposito" style="display: none;">
                                       <ul class="list-group" id="ulDeposito"
                                          style="height: 100px; width:340px; overflow: auto"></ul>
                                    </div>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="col-sm-3">
                           <div class="form-group form-float">
                              <div class="form-line t focused">
                                 ...
                                 <label class="form-label">Movimiento Compra</label>
