...
$sql = "select * from empresa where emp_codigo between $desde and $hasta order by emp_codigo;";
...
$dompdf->stream("reporte_empresa.pdf", array('Attachment' => false));
