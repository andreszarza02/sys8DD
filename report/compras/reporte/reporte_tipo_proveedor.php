...
$sql = "select * from tipo_proveedor where tipro_codigo between $desde and $hasta order by tipro_codigo;";
...
<head>
   ...
   <title>Reporte Tipo Proveedor</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE TIPOS DE PROVEEDORES</h4>
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['tipro_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipro_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipro_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
...
$dompdf->stream("reporte_tipo_proveedor.pdf", array('Attachment' => false));
