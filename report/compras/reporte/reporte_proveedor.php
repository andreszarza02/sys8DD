...
$sql = "select p.*, tp.tipro_descripcion from proveedor p join tipo_proveedor tp on p.tipro_codigo=tp.tipro_codigo 
where p.pro_codigo between $desde and $hasta order by p.pro_codigo";
