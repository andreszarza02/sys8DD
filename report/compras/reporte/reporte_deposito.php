...
$sql = "select d.*, e.emp_razonsocial, s.suc_descripcion, c.ciu_descripcion
...
join empresa e on e.emp_codigo=s.emp_codigo where d.dep_codigo between $desde and $hasta
...
$dompdf->stream("reporte_deposito.pdf", array('Attachment' => false));
