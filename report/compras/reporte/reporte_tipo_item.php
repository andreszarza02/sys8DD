...
$sql = "select * from tipo_item where tipit_codigo between $desde and $hasta order by tipit_codigo;";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['tipit_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipit_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipit_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
