...
$sql = "select * from tipo_impuesto where tipim_codigo between $desde and $hasta order by tipim_codigo;";
...
<head>
   ...
   <title>Reporte Tipo Impuesto</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE TIPOS DE IMPUESTOS</h4>
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['tipim_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipim_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipim_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
...
$dompdf->stream("reporte_tipo_impuesto.pdf", array('Attachment' => false));
