...
<head>
   ...
   <title>Informes Referenciales Produccion</title>
   ...
   <section class="content">
      <div class="container-fluid">
         <div class="row clearfix">
            ...
            <!-- Formulario Informes Refereciales Produccion -->
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="card">
                  <div class="header">
                     <h2>
                        INFORMES REFERENCIALES PRODUCCION
                     </h2>
                  </div>
                  <div class="body">
                     <div class="row clearfix">
                        <div class="col-sm-4">
                           <div class="form-group form-float">
                              <div class="form-line t focused">
                                 ...
                                 <label class="form-label">Referenciales Produccion</label>
