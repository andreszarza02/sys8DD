...
$sql = "select * from maquinaria where maq_codigo between $desde and $hasta order by maq_codigo";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['maq_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['maq_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['maq_estado'] ?>
               </td>
...
$dompdf->stream("reporte_maquinaria.pdf", array('Attachment' => false));
