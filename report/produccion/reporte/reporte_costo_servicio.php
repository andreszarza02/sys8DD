...
$sql = "select cs.*, m.mod_codigomodelo from costo_servicio cs join modelo m on m.mod_codigo=cs.mod_codigo
where cs.costserv_codigo between $desde and $hasta order by cs.costserv_codigo";
...
<head>
   ...
   <title>Reporte Costo Servicio</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE COSTOS DE SERVICIO</h4>
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['costserv_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['costserv_costo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['mod_codigomodelo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['costserv_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
