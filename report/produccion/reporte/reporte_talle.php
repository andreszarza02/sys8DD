...
$sql = "select * from talle where tall_codigo between $desde and $hasta order by tall_codigo";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['tall_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tall_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tall_estado'] ?>
               </td>
...
$dompdf->stream("reporte_cargo.pdf", array('Attachment' => false));
