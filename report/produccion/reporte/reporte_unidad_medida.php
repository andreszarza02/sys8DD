...
$sql = "select * from unidad_medida where unime_codigo between $desde and $hasta order by unime_codigo;";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['unime_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['unime_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['unime_estado'] ?>
               </td>
...
$dompdf->stream("reporte_unidades_medida.pdf", array('Attachment' => false));
