...
from equipo_trabajo et
    ...
    where s.secc_codigo between $desde and $hasta
...
<head>
   ...
   <title>Reporte Equipo Trabajo</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE EQUIPOS DE TRABAJO</h4>
...
$dompdf->stream("reporte_equipo_trabajo.pdf", array('Attachment' => false));
