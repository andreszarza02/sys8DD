...
$sql = "select * from color_prenda where col_codigo between $desde and $hasta order by col_codigo;";
...
<head>
   ...
   <title>Reporte Color Prenda</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE COLORES DE PRENDA</h4>
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['col_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['col_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['col_estado'] ?>
               </td>
...
$dompdf->stream("reporte_color_prenda.pdf", array('Attachment' => false));
