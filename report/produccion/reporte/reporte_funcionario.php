...
$sql = "select 
      ...
      from funcionario f
         ...
         where f.func_codigo between $desde and $hasta
...
$dompdf->stream("reporte_funcionario.pdf", array('Attachment' => false));
