...
$sql = "select * from acceso a where a.acc_fecha between '$desde' and '$hasta' order by a.acc_codigo";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['acc_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['acc_usuario'] ?>
               </td>
               <td class="celda">
...
$dompdf->stream("reporte_acceso.pdf", array('Attachment' => false));
