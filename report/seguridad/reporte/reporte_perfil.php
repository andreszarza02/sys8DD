...
$sql = "select * from perfil where perf_codigo between $desde and $hasta order by perf_codigo";
...
$dompdf->stream("reporte_perfil.pdf", array('Attachment' => false));
