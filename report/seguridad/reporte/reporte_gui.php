...
$sql = "select g.*, m.modu_descripcion from gui g join modulo m on m.modu_codigo=g.modu_codigo where g.gui_codigo between $desde and $hasta order by g.gui_codigo";
