...
$sql = "select * from modulo where (modu_codigo between $desde and $hasta) order by modu_codigo";
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['modu_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['modu_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['modu_estado'] ?>
               </td>
