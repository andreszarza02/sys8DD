...
<head>
   ...
   <title>Reporte Perfil Gui</title>
   <style>
      .tabla {
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               ...
               <td class="celda">
                  <?php echo $fila['gui_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['perfgui_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
...
$dompdf->stream("reporte_perfil_gui.pdf", array('Attachment' => false));
