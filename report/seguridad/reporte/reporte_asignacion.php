...
$sql = "select apu.*, u.usu_login , p.perf_descripcion, p2.perm_descripcion from asignacion_permiso_usuario apu
...
join permisos p2 on p2.perm_codigo=pp.perm_codigo where apu.asigperm_codigo between $desde and $hasta order by apu.asigperm_codigo";
...
<head>
   ...
   <title>Reporte Asignacion Permiso Usuario</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE ASIGNACION PERMISO USUARIO</h4>
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               ...
               <td class="celda">
                  <?php echo $fila['perm_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['asigperm_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
...
$dompdf->stream("reporte_asignacion_permiso_usuario.pdf", array('Attachment' => false));
