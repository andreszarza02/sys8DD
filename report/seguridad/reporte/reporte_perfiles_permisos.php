...
$sql = "select pp.*, perf.perf_descripcion, perm.perm_descripcion from perfiles_permisos pp  
join perfil perf on perf.perf_codigo=pp.perf_codigo join permisos perm on perm.perm_codigo=pp.perm_codigo
where pp.perfpe_codigo between $desde and $hasta order by perfpe_codigo";
...
<head>
   ...
   <title>Reporte Perfiles Permisos</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE PERFILES PERMISOS</h4>
