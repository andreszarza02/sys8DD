...
$sql = "select * from tipo_documento td where td.tipdo_codigo between $desde and $hasta order by td.tipdo_codigo";
...
<head>
   ...
   <title>Reporte Tipo Documento</title>
   <style>
      .tabla {
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['tipdo_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipdo_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['tipdo_estado'] ?>
               </td>
