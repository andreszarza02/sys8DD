...
$sql = "select c.*, s.suc_descripcion, e.emp_razonsocial 
      ...
      where c.caj_codigo between $desde and $hasta
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['caj_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['caj_descripcion'] ?>
               </td>
               <td class="celda">
...
$dompdf->stream("reporte_caja.pdf", array('Attachment' => false));
