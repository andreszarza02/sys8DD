...
$sql = "select * from forma_cobro fc where fc.forco_codigo between $desde and $hasta order by fc.forco_codigo;";
...
<head>
   ...
   <title>Reporte Forma Cobro</title>
   <style>
      .tabla {
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['forco_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['forco_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['forco_estado'] ?>
               </td>
