...
$sql = "select * from marca_tarjeta mt where mt.marta_codigo between $desde and $hasta order by mt.marta_codigo";
...
<head>
   ...
   <title>Reporte Marca Tarjeta</title>
   <style>
      .tabla {
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['marta_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['marta_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['marta_estado'] ?>
               </td>
