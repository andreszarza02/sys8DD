...
$sql = "select ea.*, ee.ent_razonsocial, mt.marta_descripcion from entidad_adherida ea
         join entidad_emisora ee on ee.ent_codigo=ea.entad_codigo join marca_tarjeta mt on mt.marta_codigo=ea.marta_codigo
         where ea.entad_codigo between $desde and $hasta
...
<head>
   ...
   <title>Reporte Entidad Adherida</title>
   <style>
      .tabla {
...
<body>
   ...
   <h4>LISTA DE ENTIDAD ADHERIDA</h4>
   ...
   <table class="tabla">
      ...
      <tbody>
         <?php foreach ($datos as $fila) { ?>
            <tr class="fila">
               <td class="celda">
                  <?php echo $fila['entad_codigo'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['ent_razonsocial'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['marta_descripcion'] ?>
               </td>
               <td class="celda">
                  <?php echo $fila['entad_estado'] ?>
               </td>
            </tr>
         <?php } ?>
      </tbody>
